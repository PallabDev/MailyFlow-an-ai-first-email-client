...
import { RefreshCw, AlertCircle, CornerUpLeft, Send, Paperclip, X } from 'lucide-react';
import { getEmailHtml, parseSender, getInitials, getAvatarColor, formatEmailDate, isRichHtml } from '@/lib/email-helper';
import { useChatStore } from '@/features/ai/store/chatStore';
import { usePathname, useRouter } from 'next/navigation';
import toast from 'react-hot-toast';
import AISvg from '@/features/ai/components/AISvg';
